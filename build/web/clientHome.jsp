...
<body>
 <div class="row" style="text-align: center; margin-top: 10px">
  <h1 style="color: cornsilk; font-weight: bold; font-size: 35px">Welcome to the Fall 2023 Project 4 Enterprise System</h1>
 </div>
 <div class="row" style="text-align: center;">
  <p style="color:white; font-size:  18px;">You are connected to the Project 4 Enterprise System database as a <i style="color: red;">client-level</i> user.</p>
 </div>
 <div class="row" style="text-align: center;">
 ...
 <div class="container">
  <form action="ClientUserServlet" method="post">
   <div class="row ">
    ...
    <div class="col-sm-6"> 
        <textarea id="queryInput" style=" background-color: mediumslateblue; color: yellow" name="queryInput" rows="10" cols="79"></textarea> 
   </div>
   <div class="row">
    <div class="col-sm-3"></div>
 ...
 <hr>
 <div class="row" style="text-align: center;margin-top: 20px">
  <p style="color:mediumslateblue; font-size:  24px; font-weight: bold">Execution Results: </p>
 </div>
 <div class="container"> 
    <% if (result != null) { %> 
